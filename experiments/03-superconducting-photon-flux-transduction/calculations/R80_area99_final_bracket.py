#!/usr/bin/env python3
"""Final high-statistics refinement of the current R80 14-um P~.99 screening bracket.

These are symmetrized-FDT TWA screening fractions, not exact quantum efficiencies.
"""
...
def main():
    ...
    R=80.; alpha=.90; lam=14.; rise=20.; dt=.125; N=8192; seed=737737
    print('Experiment 03 R80 final area99 bracket refinement')
    for A in (86.0,86.5,87.0,87.5,88.0):
        ...
        print(msg); print(f'::notice title=Experiment 03 R80 final area99::{msg}')
    print('PASS')
