...
-\frac23\delta_{ij}x_k
\right)^2\\
&=6r^2-\frac{8}{3}r^2+\frac{4}{3}r^2\\
&=\frac{20}{3}r^2.
\end{align}
Here the first term includes the two diagonal squares and their cross term; the last two terms arise from the trace subtraction and its interference with the symmetric part.
