...
\label{eq:factor}
\end{equation}
to retained narrowband order. Here $H_A$ maps the selected source inputs to the complete retained set of gravitational output ports, $H_B$ maps the complete retained gravitational input set to selected receiver outputs, and $P_g$ is the normalized free-space gravitational propagation operator. Nongravitational loss ports remain in the total operator $K$; such losses can make the final ceiling very loose, but cannot increase the allowed transfer. Let
\begin{equation}
